...
The default of the graph output will be that of your own implementation. To switch between your graph and the reference graph, use the `G` and `R` buttons to the right. `G` is the graph produced by your code and `R` is the graph from the reference implementation.
